...
class Question
{
     ...
     * @Assert\Choice(choices = {"choice", "choice_multi", "choice_emotive", "choice_boolean", "text", "float", "date", "date_quit", "float_spend_weekly", "choice_boolean_reset"}, message = "The question type selected is not valid", strict = true)
     */
